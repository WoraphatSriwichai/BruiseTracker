...
import { faHome, faCalculator, faChartBar, faExpand, faEraser, faInfoCircle, faEnvelope, faUser,faPhone, faGlobe, faArrowLeft, faSave } from '@fortawesome/free-solid-svg-icons';
        ...
        <div className="edit-container">
          <div className="edit-info">
            ...
            <div className="edit-buttons">
              <button className="edit-button" onClick={handleNavigation(-1)}>
                <FontAwesomeIcon
                  icon={faArrowLeft}
